# Insightfuls_01
Development Operations to serve user submission of musculoskeletal radiographies to a hospital cloud network that facilitates storing files and continued training of the Deep Learning model with an emphasis of maintaining site availability during infrastructure failures. 
